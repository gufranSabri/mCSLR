...
from mska_og.Tokenizer import GlossTokenizer_S2G
from mska_og.Visualhead import VisualHead
...
class Recognition(nn.Module):
    ...
    def forward(self, src_input):
        ...
        body_head = self.body_visual_head(
            x=body,
            mask=src_input['mask'].to("cuda"),
            valid_len_in=src_input['new_src_lengths'].to("cuda"))
        ...
        return fuse_head['gloss_feature'], body_head['gloss_feature'], left_head['gloss_feature'], right_head['gloss_feature']